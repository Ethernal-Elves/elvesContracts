            ...
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"Artifacts","description":"EthernalElves Artifacts is a collection of rare fragments. A combination of these artifacts can be used to awaken The Elders and other elements within the Elvenverse.",',
