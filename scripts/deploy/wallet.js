...
async function deployContracts() {
  ...
  const ElvenWallet = await ethers.getContractFactory("ElvenWallet");
  const contractObject = await upgrades.deployProxy(ElvenWallet);

 console.log("deployed wallet proxy")
